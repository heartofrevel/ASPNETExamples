<%@ Page Language="C#" AutoEventWireup="true" CodeFile="registrationDone.aspx.cs" Inherits="regsitrationDone" %>
...
<body>
	...
	<div id="menubar">
      <ul id="menu">
        ...
        <li><a href="registrationDone.aspx">Register</a></li>
      </ul>
    </div><!--close menubar-->	
	...
	<div id="site_content">		
	  ...
	  <div id="content">
        <div class="content_item">
		  <h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Registration Done , Click to <a href="login.aspx" class="auto-style1">login</a>.&nbsp;</h1>
            <p>&nbsp;</p>
		  <br style="clear:both"/>
